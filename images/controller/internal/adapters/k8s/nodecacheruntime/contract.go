...
const (
	...
	UsageSummaryAnnotation         = "ai.deckhouse.io/node-cache-usage-summary"
	RuntimeNodeNameEnv             = "AI_MODELS_NODE_NAME"
	RuntimePodNameEnv              = "AI_MODELS_POD_NAME"
	RuntimePodNamespaceEnv         = "AI_MODELS_POD_NAMESPACE"
	...
	kubeAPIServiceAccountVolume    = "node-cache-runtime-kube-api-access"
