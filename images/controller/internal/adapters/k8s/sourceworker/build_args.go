...
func remoteRawStageArgs(ownerUID types.UID, rawBucket string, mode publicationports.SourceFetchMode) []string {
	if publicationports.NormalizeSourceFetchMode(mode) != publicationports.SourceFetchModeMirror {
		return nil
	}
