...
func TestRunRejectsOllamaUntilPublisherExists(t *testing.T) {
	t.Parallel()
	...
	if got, want := err.Error(), "ollama source publication is not implemented yet"; !strings.Contains(got, want) {
