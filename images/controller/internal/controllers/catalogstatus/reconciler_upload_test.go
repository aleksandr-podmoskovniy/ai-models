...
func TestModelReconcilerProjectsWaitForUploadStatus(t *testing.T) {
	...
	if updated.Status.Upload == nil || updated.Status.Upload.InClusterURL != "http://upload-worker.d8-ai-models.svc:8444/upload/token" || updated.Status.Upload.TokenSecretRef == nil {
